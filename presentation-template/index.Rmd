...
> Remember that any changes to the `CSS` must be made within the repository of this template, and not within the repositories of the workshops.

> If you feel that something must be changed, contact one of the coordinators.
]
---
